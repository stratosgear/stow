...
# `list_geometry` returns the geometry of the focused or visible
# windows.  You can also get their title by setting a second argument to
# `with_description`. The geometry and the title are seperated by `\t`.
#
# Arguments: $1: `focused` or `visible` $2: `with_description` or
#   nothing
#
# Output examples:
#   - with the `with_description` option: 12,43 100x200\tTermite
#   - without the `with_description` option: 12,43 100x200
